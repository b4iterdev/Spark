...
export GOARCH=386
go build -ldflags "-H=windowsgui -s -w -X 'Spark/client/config.Commit=$COMMIT'" -o ./built/windows_i386 Spark/client
export GOARCH=arm64
go build -ldflags "-H=windowsgui -s -w -X 'Spark/client/config.Commit=$COMMIT'" -o ./built/windows_arm64 Spark/client
export GOARCH=amd64
go build -ldflags "-H=windowsgui -s -w -X 'Spark/client/config.Commit=$COMMIT'" -o ./built/windows_amd64 Spark/client
